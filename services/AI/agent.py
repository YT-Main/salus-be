          ...
          response = self.client.chat.completions.create(
              ...
              messages=[
                  {"role": "system", "content": '''
                      ...
                      If there is no cancer (only if detected 0 cancer or no lesions detected said said other wise things like NV are cancer), respond with "No cancer detected" leaving the other sections empty!
